...
class QuizPersenScreen extends StatefulWidget {
  const QuizPersenScreen({super.key});
  @override
  State<QuizPersenScreen> createState() => _QuizPersenScreenState();
}

class _QuizPersenScreenState extends State<QuizPersenScreen> {
    ...
    _questions = [
      {
        ...
        'choices': ['25', '50', '10', '75']..shuffle(),
        'answer': '25',
        'explanation': '25/100 = 25%.',
      },
      {
        'question': 'Jika harga Rp200.000 didiskon 25%, berapa harga akhirnya?',
        'choices': ['150000', '175000', '180000', '160000']..shuffle(),
        'answer': '150000',
        'explanation': 'Diskon = 25% x 200.000 = 50.000. Harga akhir = 200.000 - 50.000 = 150.000.',
      },
      {
        'question': '40% dari 80 adalah ...',
        'choices': ['32', '40', '24', '20']..shuffle(),
        'answer': '32',
        'explanation': '40% x 80 = 0,4 x 80 = 32.',
      },
      {
        'question': 'Perbandingan 2 banding 3 dalam pecahan adalah ...',
        'choices': ['2/3', '3/2', '1/2', '3/5']..shuffle(),
        'answer': '2/3',
        'explanation': '2 banding 3 = 2/3.',
      },
      {
        'question': '60% = ... dalam bentuk pecahan paling sederhana',
        'choices': ['3/5', '2/5', '6/10', '4/5']..shuffle(),
        'answer': '3/5',
  ...
  Widget build(BuildContext context) {
    if (_showResult) {
      return Scaffold(
        appBar: AppBar(title: const Text('Latihan Persen & Perbandingan')),
        body: Center(
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () => Navigator.pushReplacementNamed(context, '/quiz_pangkat'),
